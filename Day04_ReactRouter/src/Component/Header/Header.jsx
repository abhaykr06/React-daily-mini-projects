...
// interview tip: a tag is not usefull as it repaint the page always.
                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img
                            ...
                            className="mr-3 h-12 transition-transform duration-300 hover:scale-110"
                            alt="Logo"
                        />
                    </Link>
                    <div className="flex items-center lg:order-2 space-x-3">
                        ...
                        <Link
                            to="#"
                            className="text-white bg-orange-600 hover:bg-orange-700 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold rounded-lg text-sm px-4 py-2 focus:outline-none"
                        >
                            Get started
                        </Link>
                    </div>
